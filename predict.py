...
MODEL_NAME = "dataautogpt3/ProteusV0.1"
...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        num_inference_steps: int = Input(
            description="Number of denoising steps. 20 to 35 steps for more detail, 20 steps for faster results.", ge=1, le=100, default=20
        ),
        guidance_scale: float = Input(
            description="Scale for classifier-free guidance. Recommended 7-8", ge=1, le=50, default=7.5
        ),
